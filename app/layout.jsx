  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;1,300;1,400&family=Cinzel:wght@400;500;600&family=Amiri:wght@400;700&family=Noto+Nastaliq+Urdu:wght@400;600&family=Alex+Brush&family=Great+Vibes&display=swap"
        />
      </head>
      <body>{children}</body>
    </html>
