"use client";
import { site, families, scripture, notes } from "@/data/wedding.config";
import { Divider, Monogram } from "./Ornaments";

export default function InvitationScreen({ t, guest, onDiscover }) {
  return (
    <section className="relative min-h-[100dvh] geo-bg py-16 sm:py-24 px-4">
      <div className="absolute inset-0 bg-gradient-to-b from-ink/80 via-ink/60 to-ink" />

      <div className="relative z-10 mx-auto max-w-3xl panel corner px-6 sm:px-14 py-14 sm:py-20 text-center animate-fadeUp">
      ...
      <p className="relative z-10 text-center font-caps text-[9px] tracking-widest2 text-muted/50 mt-12">
